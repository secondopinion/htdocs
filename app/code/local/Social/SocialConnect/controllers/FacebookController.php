...
class Social_SocialConnect_FacebookController extends Mage_Core_Controller_Front_Action
{
    ...
    public function connectAction()
    {
        ...
        if(!empty($this->referer)) {
            ...
            Mage::helper('social_socialconnect')->redirect404($this);
        }
    }
    ...
    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        ...
        Mage::helper('social_socialconnect/facebook')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        if ($code) {
            ...
            $client = Mage::getSingleton('social_socialconnect/facebook_client');

            $userInfo = $client->api('/me?fields=id,first_name,last_name,email,birthday');
            $token = $client->getAccessToken();

            $customersByFacebookId = Mage::helper('social_socialconnect/facebook')
            ...
            if(Mage::getSingleton('customer/session')->isLoggedIn()) {
                ...
                Mage::helper('social_socialconnect/facebook')->connectByFacebookId(
                    $customer,
                    $userInfo->id,
                    $token
                );
            ...
            if($customersByFacebookId->count()) {
                ...
                Mage::helper('social_socialconnect/facebook')->loginByCustomer($customer);
            ...
            $customersByEmail = Mage::helper('social_socialconnect/facebook')
            ...
            Mage::helper('social_socialconnect/facebook')->connectByCreatingAccount(
                $userInfo->email,
                $userInfo->first_name,
                $userInfo->last_name,
                $userInfo->id,
