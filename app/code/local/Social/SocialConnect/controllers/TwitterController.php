...
class Social_SocialConnect_TwitterController extends Mage_Core_Controller_Front_Action
{
    protected $referer = null;

    public function requestAction()
    {
        $client = Mage::getSingleton('social_socialconnect/twitter_client');
        if(!($client->isEnabled())) {
    ...
    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        ...
        Mage::helper('social_socialconnect/twitter')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        $customersByTwitterId = Mage::helper('social_socialconnect/twitter')
        ...
        if(Mage::getSingleton('customer/session')->isLoggedIn()) {
            ...
            Mage::helper('social_socialconnect/twitter')->connectByTwitterId(
                $customer,
                $userInfo->id,
                $token
            );
        ...
        if($customersByTwitterId->count()) {
            ...
            Mage::helper('social_socialconnect/twitter')->loginByCustomer($customer);
        ...
        $customersByEmail = Mage::helper('social_socialconnect/twitter')
        ...
        Mage::helper('social_socialconnect/twitter')->connectByCreatingAccount(
            $userInfo->email,
            $userInfo->name,
            $userInfo->id,
            $token
