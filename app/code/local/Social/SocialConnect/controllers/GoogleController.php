...
class Social_SocialConnect_GoogleController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        ...
        Mage::helper('social_socialconnect/google')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        if ($code) {
            ...
            $client = Mage::getSingleton('social_socialconnect/google_client');

            $userInfo = $client->api('/userinfo');
            $token = $client->getAccessToken();

            $customersByGoogleId = Mage::helper('social_socialconnect/google')
            ...
            if(Mage::getSingleton('customer/session')->isLoggedIn()) {
                ...
                Mage::helper('social_socialconnect/google')->connectByGoogleId(
                    $customer,
                    $userInfo->id,
                    $token
                );
            ...
            if($customersByGoogleId->count()) {
                ...
                Mage::helper('social_socialconnect/google')->loginByCustomer($customer);
            ...
            Mage::helper('social_socialconnect/google')->connectByCreatingAccount(
                $userInfo->email,
                $userInfo->given_name,
