...
class Social_SocialConnect_Model_Facebook_Userinfo
{
    ...
    public function __construct() {
        ...
        if(($socialconnectFid = $customer->getSocialSocialconnectFid()) &&
                ($socialconnectFtoken = $customer->getSocialSocialconnectFtoken())) {
            $helper = Mage::helper('social_socialconnect/facebook');
