...
class Social_SocialConnect_Model_Google_Client
{
    const REDIRECT_URI_ROUTE = 'socialconnect/google/connect';

    const XML_PATH_ENABLED = 'customer/social_socialconnect_google/enabled';
    const XML_PATH_CLIENT_ID = 'customer/social_socialconnect_google/client_id';
    const XML_PATH_CLIENT_SECRET = 'customer/social_socialconnect_google/client_secret';
