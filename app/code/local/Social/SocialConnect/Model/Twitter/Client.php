...
class Social_SocialConnect_Model_Twitter_Client
{
    ...
    const XML_PATH_ENABLED = 'customer/social_socialconnect_twitter/enabled';
    const XML_PATH_CLIENT_ID = 'customer/social_socialconnect_twitter/client_id';
    const XML_PATH_CLIENT_SECRET = 'customer/social_socialconnect_twitter/client_secret';
