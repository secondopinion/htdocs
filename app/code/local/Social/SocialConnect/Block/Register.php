...
class Social_SocialConnect_Block_Register extends Mage_Core_Block_Template
{
    ...
    protected function _construct() {
        ...
        Mage::register('social_socialconnect_button_text', $this->__('Register'));

        $this->setTemplate('social/socialconnect/register.phtml');
    }
