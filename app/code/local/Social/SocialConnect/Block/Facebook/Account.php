...
class Social_SocialConnect_Block_Facebook_Account extends Mage_Core_Block_Template
{
    ...
    protected function _construct() {
        ...
        $this->client = Mage::getSingleton('social_socialconnect/facebook_client');
        if(!($this->client->isEnabled())) {
            return;
        }

        $this->userInfo = Mage::registry('social_socialconnect_facebook_userinfo');

        $this->setTemplate('social/socialconnect/facebook/account.phtml');
    }
    ...
    protected function _getPicture()
    {
        if(!empty($this->userInfo->picture)) {
            return Mage::helper('social_socialconnect/facebook')
