...
class Social_SocialConnect_Block_Checkout extends Mage_Core_Block_Template
{
    ...
    protected function _construct() {
        ...
        $this->clientGoogle = Mage::getSingleton('social_socialconnect/google_client');
        $this->clientFacebook = Mage::getSingleton('social_socialconnect/facebook_client');
        $this->clientTwitter = Mage::getSingleton('social_socialconnect/twitter_client');
        ...
        Mage::register('social_socialconnect_button_text', $this->__('Continue'));

        $this->setTemplate('social/socialconnect/checkout.phtml');
    }
