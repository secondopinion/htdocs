...
class Social_SocialConnect_Block_Login extends Mage_Core_Block_Template
{
    ...
    protected function _construct() {
        ...
        Mage::register('social_socialconnect_button_text', $this->__('Login'));

        $this->setTemplate('social/socialconnect/login.phtml');
    }
