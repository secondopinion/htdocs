...
class Social_SocialConnect_Block_Twitter_Account extends Mage_Core_Block_Template
{
    ...
    protected function _construct() {
        ...
        $this->client = Mage::getSingleton('social_socialconnect/twitter_client');
        if(!($this->client->isEnabled())) {
            return;
        }

        $this->userInfo = Mage::registry('social_socialconnect_twitter_userinfo');

        $this->setTemplate('social/socialconnect/twitter/account.phtml');
    ...
    protected function _getPicture()
    {
        if(!empty($this->userInfo->profile_image_url)) {
            return Mage::helper('social_socialconnect/twitter')
