...
class Social_SocialConnect_Block_Google_Account extends Mage_Core_Block_Template
{
    ...
    protected function _construct() {
        ...
        $this->setTemplate('social/socialconnect/google/account.phtml');
    ...
    protected function _getPicture()
    {
        if(!empty($this->userInfo->picture)) {
            return Mage::helper('social_socialconnect/google')
